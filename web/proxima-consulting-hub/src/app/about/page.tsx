            ...
            <ol>
                <li>
                    ...
                    <ul className="ps-5">
                        ...
                        <li>
                            Integrates with the Client Server for authentication
                ...
                <li>
                    ...
                    <p>
                        Handles business logic and provides data access to
                        clients
                    </p>
                    <ul className="ps-5">
                        <li>
                        ...
                        <li>
                            i.e.: Exposes GraphQL endpoints for data retrieval
                            and manipulation
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul className="ps-5">
                        ...
                        <li>
                            i.e.: Spring Gateway being a client of our
                ...
                <li>
                    ...
                    <ul className="ps-5">
                        ...
                        <li>
                            The portal has middleware, authentication context
                            and cookie validation on the server side for secure
                            browsing.
                        </li>
                    </ul>
                </li>
