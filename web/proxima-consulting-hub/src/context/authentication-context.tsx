...
export const AuthenticationContextProvider = ({
    ...
    const [userInfo, setUserInfo] = usePersistedState<UserInfoType | null>("userInfo", {} as UserInfoType);

    const checkIfUserInfoIsValid = useCallback((userInfo:UserInfoType | null) => {
    ...
    const isAuthenticated = useMemo(() => !!userInfo && !!userInfo?.sub, [userInfo])
