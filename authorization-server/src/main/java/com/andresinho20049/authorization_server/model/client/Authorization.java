...
public class Authorization {
	...
	@Column(name = "registered_client_id", length = 1000, nullable = false)
	private String registeredClientId;

	@Column(name = "principal_name", length = 500, nullable = false)
	private String principalName;

	@Column(name = "authorization_grant_type", length = 2000, nullable = false)
	...
	@Column(name = "access_token_type", length = 2000)
